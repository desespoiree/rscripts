...
local ProtectGui = (syn and syn.protect_gui) or protectgui or gethui or get_hidden_gui or (function() end)
                ...
                IsBadDrawingLib = not (pcall(function()
                    ...
                    RunService:BindToRenderStep("__LinoriaCursor", Enum.RenderPriority.Camera.Value - 1, function()
                        ...
                        if not Toggled or (not ScreenGui or not ScreenGui.Parent) then
                            ...
                            InputService.MouseBehavior = OldMouseBehavior
